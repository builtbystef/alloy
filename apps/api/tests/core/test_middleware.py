...
from alloy_api.core.logs import RequestIdFilter, request_id
from alloy_api.core.middleware import (
...
def test_unhandled_error_becomes_a_500_with_the_request_id(
    ...
    with caplog.at_level(logging.ERROR, logger="alloy_api.core.middleware"):
    ...
    [record] = [r for r in caplog.records if r.name == "alloy_api.core.middleware"]
