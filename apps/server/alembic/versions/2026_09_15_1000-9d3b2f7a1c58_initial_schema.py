...
def upgrade() -> None:
    # --- App tables --------------------------------------------------------------
    # Autogenerated, so in dependency order rather than by area; each table is
    # labelled with its area.
    ...
    # imports belongs to CSV imports.
    op.create_table(
        "imports",
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("workspace_id", sa.Uuid(), nullable=False),
    ...
    # user_sessions belongs to accounts.
    op.create_table(
        "user_sessions",
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("user_id", sa.Uuid(), nullable=False),
    ...
    # workspace_invites belongs to workspaces.
    op.create_table(
        "workspace_invites",
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("workspace_id", sa.Uuid(), nullable=False),
    ...
    # workspace_members belongs to workspaces.
    op.create_table(
        "workspace_members",
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("workspace_id", sa.Uuid(), nullable=False),
    ...
    # --- Rate limits -------------------------------------------------------------
    # UNLOGGED: not worth a WAL write, fine to lose on a crash.
    op.create_table(
        "rate_limit_windows",
