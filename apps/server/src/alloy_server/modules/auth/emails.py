...
def verification_email(user: User, token: str, frontend_url: str, ttl: timedelta) -> Email:
    ...
    text = (
        ...
        f"{link}\n"
        f"\n"
        f"The link works once, for {validity}. If you did not create an account, you can "
        f"ignore this email."
    )
    html = (
        ...
        f"<p>The link works once, for {escape(validity)}. If you did not create an account, "
