...
from alloy_server.modules.crm.attachments.service import delete_with_attachments
from alloy_server.modules.crm.companies.models import Company
from alloy_server.modules.crm.contacts.models import CONTACT_ACTIVITY_TYPES, Activity, Contact
from alloy_server.modules.crm.contacts.schemas import ContactSort
from alloy_server.modules.crm.ownership import check_owned, fetch_owned
from alloy_server.modules.crm.pagination import sorted_by
...
if TYPE_CHECKING:
    ...
    from alloy_server.modules.crm.contacts.schemas import (
        ActivityCreate,
        ContactCreate,
        ContactFilters,
        ContactUpdate,
