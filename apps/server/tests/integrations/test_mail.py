...
from alloy_server.integrations.mail import ConsoleMailer, Email, create_mailer
...
async def test_console_mailer_logs_the_message(caplog: pytest.LogCaptureFixture):
    ...
    with caplog.at_level(logging.INFO, logger="alloy_server.integrations.mail.console"):
